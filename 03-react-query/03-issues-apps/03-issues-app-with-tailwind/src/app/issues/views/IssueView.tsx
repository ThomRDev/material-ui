...
// codigo markdown en una variable
// por eso instalamos react-markdown para que renderize esto
const comment1 =
...
export const IssueView = () => {
  return (
    <main className="w-[min(95%,1400px)] mx-auto">
      <div className="mb-2">
        <Link
          to={"/issues/list"}
          className="underline text-blue-600 hover:text-blue-600/75"
        >
          Go back
        </Link>
      </div>
      <div className="flex flex-col gap-2">
        <IssueComment comment={comment1} />
        <IssueComment comment={comment2} />
        <IssueComment comment={comment3} />
      </div>
    </main>
  );
};
